...
# Go #
######
alias gofmtall='find . -type f -name "*.go" -not -name "*.pb.go" -print0 | xargs -0 gofmt -w'
alias goimportsall='find . -type f -name "*.go" -not -name "*.pb.go" -print0 | xargs -0 goimports -w'
